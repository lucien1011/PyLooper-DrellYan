...
plots = [
        ...
        Plot("pT4l",lambda data,dataset,cfg: data["pT4l"],lambda data,dataset,cfg: cfg.collector.event_weight,hist=Hist1D(50,0.,100.),),
        Plot("rapidity4l",lambda data,dataset,cfg: data["rapidity4l"],lambda data,dataset,cfg: cfg.collector.event_weight,hist=Hist1D(50,-5.,5.),),
        Plot("pTZ1",lambda data,dataset,cfg: data["pTZ1"],lambda data,dataset,cfg: cfg.collector.event_weight,hist=Hist1D(50,0.,100.),),
        Plot("pTZ2",lambda data,dataset,cfg: data["pTZ2"],lambda data,dataset,cfg: cfg.collector.event_weight,hist=Hist1D(50,0.,100.),),
